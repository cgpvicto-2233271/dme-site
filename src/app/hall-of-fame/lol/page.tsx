...
export default function HallOfFameLolPage() {
  return (
    <GameResultsPage
      ...
      lead={{
        fr: "LAN UQTR · LAN CFPR · LAN Parro · AVL · GGL · LQL — six titres, 7 000$+ de cashprize en un an.",
        en: "LAN UQTR · LAN CFPR · LAN Parro · AVL · GGL · LQL — six titles, 7 000$+ in prize money in one year.",
      }}
