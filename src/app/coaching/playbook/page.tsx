...
import { DD_CHAMPION_IMG, CURRENT_LOL_PATCH } from "@/lib/coaching-constants";
...
interface PlaybookEntry {
  ...
  bullets?:   string[];
  bulletsEn?: string[];
  champs?:    { tier: string; keys: string[] }[];
  tags?:      string[];
  source?:    string;
}
...
const SECTIONS: PlaybookSection[] = [
  ...
  {
    id: "meta", label: "Meta by Lane", labelFr: "Méta par Lane", icon: Swords, color: "#fbbf24",
    entries: [
      {
        title: `Top Lane · Méta ${CURRENT_LOL_PATCH}`,
        body: ["Priorités top lane : tanks/bruisers qui gèrent la lane priority et participent aux Voidgrubs et au premier drake. Les picks S sont flexibles en blind."],
        bodyEn: ["Top lane priorities: tanks/bruisers that hold lane priority and impact Voidgrubs and first drake. S picks are blind-safe."],
        champs: [
          { tier: "S", keys: ["Aatrox", "KSante", "Gnar"] },
          { tier: "A", keys: ["Renekton", "Jax", "Ambessa", "Rumble"] },
          { tier: "B", keys: ["Camille", "Jayce", "Ornn", "Gragas", "Sett"] },
        ],
        tags: ["Méta", "TOP"],
        source: "Méta compétitive — baseline à ajuster par patch",
      },
      {
        title: `Jungle · Méta ${CURRENT_LOL_PATCH}`,
        body: ["Jungle : engage/contrôle d'objectif et tempo early. Privilégier les junglers à fort impact sur scuttle et premiers drakes."],
        bodyEn: ["Jungle: engage/objective control and early tempo. Favor junglers with strong scuttle and early drake impact."],
        champs: [
          { tier: "S", keys: ["Vi", "Sejuani", "XinZhao"] },
          { tier: "A", keys: ["Viego", "JarvanIV", "MonkeyKing", "LeeSin"] },
          { tier: "B", keys: ["Zac", "Ekko", "Briar", "Pantheon"] },
        ],
        tags: ["Méta", "JGL"],
        source: "Méta compétitive — baseline à ajuster par patch",
      },
      {
        title: `Mid Lane · Méta ${CURRENT_LOL_PATCH}`,
        body: ["Mid : contrôle de wave, prio et roam. Les mages de contrôle restent la colonne vertébrale, avec des assassins en flex."],
        bodyEn: ["Mid: wave control, priority and roams. Control mages remain the backbone, with assassins as flex."],
        champs: [
          { tier: "S", keys: ["Azir", "Orianna", "Ahri"] },
          { tier: "A", keys: ["Yone", "Sylas", "Taliyah", "Hwei"] },
          { tier: "B", keys: ["Viktor", "Galio", "Syndra", "Leblanc"] },
        ],
        tags: ["Méta", "MID"],
        source: "Méta compétitive — baseline à ajuster par patch",
      },
      {
        title: `Bot Lane · Méta ${CURRENT_LOL_PATCH}`,
        body: ["Bot : ADC scaling et lane sûre. Caitlyn/Ezreal dominent le tempo, hypercarries en seconde phase."],
        bodyEn: ["Bot: scaling ADCs and safe lanes. Caitlyn/Ezreal control tempo, hypercarries in the second phase."],
        champs: [
          { tier: "S", keys: ["Caitlyn", "Ezreal", "Jinx"] },
          { tier: "A", keys: ["Kaisa", "Varus", "Ashe", "Jhin"] },
          { tier: "B", keys: ["Sivir", "Zeri", "Lucian", "Aphelios"] },
        ],
        tags: ["Méta", "BOT"],
        source: "Méta compétitive — baseline à ajuster par patch",
      },
      {
        title: `Support · Méta ${CURRENT_LOL_PATCH}`,
        body: ["Support : engage tanks et enchanters de tempo. Le pick support cale souvent la win condition de la composition."],
        bodyEn: ["Support: engage tanks and tempo enchanters. The support pick often sets the composition's win condition."],
        champs: [
          { tier: "S", keys: ["Rakan", "Nautilus", "Rell"] },
          { tier: "A", keys: ["Leona", "Thresh", "Alistar", "Braum"] },
          { tier: "B", keys: ["Lulu", "Renata", "Milio", "Karma"] },
        ],
        tags: ["Méta", "SUP"],
        source: "Méta compétitive — baseline à ajuster par patch",
      },
  ...
  // ════════════════════════════ JOUEURS & COACHING ════════════════════════════
  {
    id: "coaching-method", label: "Coaching Method", labelFr: "Méthode de Coaching", icon: GraduationCap, color: "#22c55e",
    entries: [
      {
        title: "Le cadre de review DME",
        body: ["Une review n'est pas un procès. C'est un atelier. On part toujours d'une observation neutre, jamais d'un jugement. L'objectif n'est pas d'avoir raison, c'est que le joueur reparte avec UNE chose claire à travailler."],
        bodyEn: ["A review is not a trial. It's a workshop. Always start from a neutral observation, never a judgment. The goal isn't to be right — it's that the player leaves with ONE clear thing to work on."],
        bullets: [
          "Observation neutre : « à 14:20 tu push sans vision » — pas « tu joues mal »",
          "Toujours proposer un scénario alternatif concret, pas juste pointer l'erreur",
          "1 seul axe prioritaire par session — un cerveau ne retient pas 6 corrections",
          "Vérifier la compréhension : fais reformuler le joueur avec ses mots",
          "Finir sur un drill assigné + un point fort relevé (on construit, on ne casse pas)",
        ],
        bulletsEn: [
          "Neutral observation: \"at 14:20 you push with no vision\" — not \"you play badly\"",
          "Always offer a concrete alternative play, don't just point at the mistake",
          "One priority focus per session — a brain won't retain 6 corrections",
          "Check understanding: have the player rephrase it in their own words",
          "End on an assigned drill + a strength noted (we build, we don't break)",
        ],
        tags: ["Coaching", "Review"],
      },
      {
        title: "Donner un feedback qui rentre",
        body: ["Le feedback qui ne change rien est du bruit. Un bon feedback est spécifique, rattaché à un objectif, et suivi. Le « sandwich » est mort : les joueurs pros veulent du direct, du respect et de la clarté."],
        bodyEn: ["Feedback that changes nothing is noise. Good feedback is specific, tied to a goal, and followed up. The \"sandwich\" is dead: pro players want directness, respect and clarity."],
        bullets: [
          "Spécifique > général : « ton recall timing sur la wave » > « ta macro »",
          "Rattache chaque retour à l'objectif de dev du joueur (sinon il l'oublie)",
          "Timing : jamais à chaud après une défaite — attends 30 min, débrief à froid",
          "Suivi : la review suivante commence par « où en es-tu sur le point d'avant ? »",
          "Adapte le canal : public pour le collectif, privé pour l'individuel sensible",
        ],
        bulletsEn: [
          "Specific > general: \"your recall timing on the wave\" > \"your macro\"",
          "Tie every note to the player's dev goal (otherwise they forget it)",
          "Timing: never hot after a loss — wait 30 min, cold debrief",
          "Follow-up: next review starts with \"where are you on the previous point?\"",
          "Adapt the channel: public for the collective, private for sensitive individual",
        ],
  ...
  {
    id: "player-dev", label: "Player Development", labelFr: "Développement Joueur", icon: Brain, color: "#a855f7",
    entries: [
      {
        title: "Le Plan de Développement Individuel (PDI)",
        body: ["Chaque joueur DME a un PDI vivant. Pas un document mort : un objectif macro + un objectif micro, mesurables, revus chaque semaine. On ne progresse pas « en général », on progresse sur des cibles."],
        bodyEn: ["Every DME player has a living IDP. Not a dead document: one macro goal + one micro goal, measurable, reviewed weekly. You don't improve \"in general\", you improve on targets."],
        bullets: [
          "1 objectif macro (ex. wave management en side) + 1 micro (ex. last-hit sous tour)",
          "Un KPI mesurable par objectif (CS@10, deaths sans vision, kill participation)",
          "Deadline courte (2 semaines) puis re-évaluation — pas d'objectif flou sans fin",
          "Le joueur co-écrit son PDI : il s'approprie, il ne subit pas",
          "Archive les anciens PDI : la progression visible nourrit la motivation",
        ],
        bulletsEn: [
          "1 macro goal (e.g. side wave management) + 1 micro (e.g. last-hitting under tower)",
          "One measurable KPI per goal (CS@10, deaths with no vision, kill participation)",
          "Short deadline (2 weeks) then re-evaluation — no vague open-ended goal",
          "The player co-writes their IDP: they own it, they don't endure it",
          "Archive old IDPs: visible progress fuels motivation",
        ],
        tags: ["Dev", "Joueur"],
      },
      {
        title: "Patterns d'apprentissage par rôle",
        body: ["Chaque rôle a une courbe d'apprentissage différente. On ne coache pas un support comme un mid. Voici les leviers de progression prioritaires par poste."],
        bodyEn: ["Each role has a different learning curve. You don't coach a support like a mid. Here are the priority growth levers per position."],
        bullets: [
          "TOP : matchups + TP timing + gestion de l'isolement (jouer sans la jungle)",
          "JGL : tracking jungle adverse, pathing autour des objectifs, lecture de map",
          "MID : prio de wave, roams timés, contrôle du tempo mid-game",
          "BOT : last-hit sous pression, positionnement teamfight, courbe de scaling",
          "SUP : vision proactive, engage/disengage read, shotcalling early",
        ],
        bulletsEn: [
          "TOP: matchups + TP timing + island management (playing without jungle)",
          "JGL: enemy jungle tracking, pathing around objectives, map reading",
          "MID: wave priority, timed roams, mid-game tempo control",
          "BOT: last-hitting under pressure, teamfight positioning, scaling curve",
          "SUP: proactive vision, engage/disengage read, early shotcalling",
        ],
        tags: ["Dev", "Rôles"],
      },
    ],
  ...
  // ════════════════════════════ ÉQUIPE & ORG ════════════════════════════
  {
    id: "team-mgmt", label: "Team Management", labelFr: "Management d'Équipe", icon: Users, color: "#06b6d4",
    entries: [
      {
        title: "La semaine type & structure de scrim",
        body: ["Une équipe pesante n'improvise pas sa semaine. Volume contrôlé, repos réel, review systématique. Le but : que chaque bloc de scrim ait une intention, pas juste « jouer des games »."],
        bodyEn: ["A heavyweight team doesn't improvise its week. Controlled volume, real rest, systematic review. The goal: every scrim block has an intent, not just \"playing games\"."],
        bullets: [
          "Bloc scrim = 2 à 3 BO, jamais à l'infini : la qualité chute après 3 séries",
          "Review immédiate à froid après chaque bloc (10-15 min, pas 1h)",
          "1 jour OFF total non-négociable : le burnout tue plus d'équipes que le skill",
          "Soloq cadrée avec objectif PDI, pas du spam sans intention",
          "Theory/draft session séparée des scrims (cerveau frais)",
        ],
        bulletsEn: [
          "Scrim block = 2 to 3 BOs, never endless: quality drops after 3 series",
          "Immediate cold review after each block (10-15 min, not 1h)",
          "One full OFF day non-negotiable: burnout kills more teams than skill",
          "Framed soloq with an IDP goal, not spam without intent",
          "Theory/draft session separate from scrims (fresh brain)",
        ],
        tags: ["Management", "Scrim"],
      },
      {
        title: "Conflits, rôles & communication",
        body: ["Les équipes ne cassent pas sur le skill, elles cassent sur la communication. Des rôles clairs (shotcaller, drafter, capitaine) et un cadre de conflit évitent 90% des explosions de roster."],
        bodyEn: ["Teams don't break on skill, they break on communication. Clear roles (shotcaller, drafter, captain) and a conflict framework prevent 90% of roster blowups."],
        bullets: [
          "Définir QUI call quoi : un seul shotcaller en teamfight, un seul drafter",
          "Règle d'or comms : in-game = factuel et court, émotionnel = après la game",
          "Conflit : on attaque le problème, jamais la personne — 1:1 avant le groupe",
          "Le capitaine relaie le moral au staff avant que ça explose",
          "Réunion hebdo non-tactique : ressenti, fatigue, tensions — vider le sac",
        ],
        bulletsEn: [
          "Define WHO calls what: one shotcaller in teamfights, one drafter",
          "Comms golden rule: in-game = factual and short, emotional = after the game",
          "Conflict: attack the problem, never the person — 1:1 before the group",
          "The captain relays morale to staff before it explodes",
          "Weekly non-tactical meeting: feelings, fatigue, tensions — clear the air",
        ],
        tags: ["Management", "Comms"],
      },
    ],
  },
  {
    id: "match-plans", label: "Match Plans", labelFr: "Plans de Match", icon: ClipboardList, color: "#e1192d",
    entries: [
      {
        title: "Routine de prep match (J-1)",
        body: ["Le match se gagne la veille. Une prep structurée enlève le stress et donne un plan clair. Le jour J, on exécute, on ne découvre rien."],
        bodyEn: ["The match is won the day before. Structured prep removes stress and gives a clear plan. On game day, you execute — you discover nothing."],
        bullets: [
          "Scout adversaire : champion pool par joueur, picks de confort, faiblesses",
          "3 plans de draft préparés (blue side / red side / si ban clé)",
          "Définir LA win condition de l'équipe pour ce match précis",
          "Briefer les flex picks et les bans cibles avant d'entrer en draft",
          "Routine mentale : sommeil, repas, warmup soloq léger — pas de tryhard la veille",
        ],
        bulletsEn: [
          "Scout opponent: champion pool per player, comfort picks, weaknesses",
          "3 prepared draft plans (blue side / red side / if key ban)",
          "Define THE team win condition for this specific match",
          "Brief flex picks and target bans before entering draft",
          "Mental routine: sleep, food, light soloq warmup — no tryhard the night before",
        ],
        tags: ["Prep", "Draft"],
        source: "Couplé au Simulateur de Draft & au Match Data",
      },
      {
        title: "Plan BO3 / BO5",
        body: ["Un BO ne se joue pas game par game, il se joue en série. Gérer ses bans dans la durée, ses pockets picks et l'adaptation game-à-game fait la différence entre une équipe et un roster."],
        bodyEn: ["A BO isn't played game by game, it's played as a series. Managing bans over time, pocket picks and game-to-game adaptation separates a team from a roster."],
        bullets: [
          "Game 1 : impose ton plan A, observe les priorités adverses",
          "Garde un pocket pick pour la game décisive — ne le montre pas trop tôt",
          "Adapte tes bans à mesure que les picks de confort adverses se révèlent",
          "Side selection : choisis le side selon TA win condition, pas par réflexe",
          "Reset mental entre les games : 1 point tactique + 1 point d'énergie, c'est tout",
        ],
        bulletsEn: [
          "Game 1: impose your plan A, observe enemy priorities",
          "Keep a pocket pick for the decider — don't show it too early",
          "Adapt your bans as enemy comforts reveal themselves",
          "Side selection: pick side based on YOUR win condition, not reflex",
          "Mental reset between games: 1 tactical point + 1 energy point, that's it",
        ],
        tags: ["Prep", "BO"],
      },
    ],
  ...
  {
    id: "org-build", label: "Build a Heavyweight Org", labelFr: "Construire une Org Pesante", icon: Crown, color: "#fbbf24",
    entries: [
      {
        title: "Les standards non-négociables",
        body: ["Une org devient pesante par ses standards, pas par son logo. Ponctualité, préparation, attitude : ce qui est toléré devient la norme. DME ne tolère pas la médiocrité d'engagement."],
        bodyEn: ["An org becomes heavyweight through its standards, not its logo. Punctuality, preparation, attitude: what's tolerated becomes the norm. DME does not tolerate mediocrity of commitment."],
        bullets: [
          "Ponctualité = respect : en retard au scrim, c'est voler le temps de 9 personnes",
          "Préparation obligatoire : on arrive en review avec ses VOD déjà regardés",
          "Attitude > talent à court terme : un toxique talentueux coûte plus qu'il rapporte",
          "Les standards s'appliquent au staff aussi — l'exemple vient d'en haut",
          "Documenter : chaque process écrit = un standard qui survit aux départs",
        ],
        bulletsEn: [
          "Punctuality = respect: late to scrim is stealing 9 people's time",
          "Mandatory prep: show up to review with your VODs already watched",
          "Attitude > short-term talent: a talented toxic player costs more than they bring",
          "Standards apply to staff too — the example comes from the top",
          "Document: every written process = a standard that survives departures",
        ],
        tags: ["Org", "Standards"],
      },
      {
        title: "Réputation, présence & poids",
        body: ["Le poids d'une org se construit dehors comme dedans. Résultats réguliers, identité visuelle forte, présence média et respect des adversaires : on devient l'équipe que les autres préparent spécifiquement."],
        bodyEn: ["An org's weight is built outside as much as inside. Consistent results, strong visual identity, media presence and opponent respect: you become the team others prep specifically for."],
        bullets: [
          "La régularité bat l'exploit : être top constamment > un coup d'éclat isolé",
          "Identité visuelle cohérente partout (rosters, réseaux, LAN) = on te reconnaît",
          "Présence média : annoncer les résultats, exister entre les matchs",
          "Respect des adversaires et des organisateurs : la réputation ouvre les portes",
          "Former des joueurs qui montent : une org qui fait grandir attire les talents",
        ],
        bulletsEn: [
          "Consistency beats the upset: being top constantly > one isolated highlight",
          "Coherent visual identity everywhere (rosters, socials, LAN) = you're recognized",
          "Media presence: announce results, exist between matches",
          "Respect opponents and organizers: reputation opens doors",
          "Develop players who rise: an org that grows people attracts talent",
        ],
        tags: ["Org", "Réputation"],
      },
    ],
  ...
  // ════════════════════════════ IDENTITÉ DME ════════════════════════════
  {
    id: "dme-identity", label: "DME Identity & Colors", labelFr: "Identité & Couleurs DME", icon: Flame, color: "#dc2626",
    entries: [
      {
        title: "Les couleurs DME",
        body: ["Porter DME, ce n'est pas porter un tag. C'est un standard de comportement et une manière de jouer. Quand on parle du playbook DME, on parle de cette identité : forgés pour la pression, faits pour compétitionner."],
        bodyEn: ["Wearing DME isn't wearing a tag. It's a behavioral standard and a way to play. When people talk about the DME playbook, they talk about this identity: forged for pressure, built to compete."],
        bullets: [
          "Forgés pour la pression : on joue mieux quand l'enjeu monte, pas l'inverse",
          "Discipline avant flair : la structure d'abord, les highlights suivent",
          "Représenter le Québec sur la scène NA — fierté et exigence",
          "Humilité dans la victoire, lucidité dans la défaite — jamais d'excuses",
          "On laisse le terrain plus haut qu'on l'a trouvé : élever les autres",
        ],
        bulletsEn: [
          "Forged for pressure: we play better when stakes rise, not the opposite",
          "Discipline before flair: structure first, highlights follow",
          "Represent Quebec on the NA scene — pride and high standards",
          "Humble in victory, lucid in defeat — never excuses",
          "Leave the game higher than you found it: lift others up",
        ],
        tags: ["Identité", "Culture"],
      },
      {
        title: "Donner la soif",
        body: ["On ne motive pas un joueur, on allume sa soif. La motivation extérieure s'épuise ; la soif intérieure se cultive par le sens, le progrès visible et l'appartenance à quelque chose de plus grand que soi."],
        bodyEn: ["You don't motivate a player, you light their hunger. External motivation runs out; inner hunger is cultivated through meaning, visible progress and belonging to something bigger than yourself."],
        bullets: [
          "Donner du SENS : relier chaque scrim à un objectif qui compte pour le joueur",
          "Rendre le progrès VISIBLE : montrer les courbes, célébrer les paliers",
          "Créer l'APPARTENANCE : on gagne et on perd ensemble, jamais seul",
          "Fixer des sommets ambitieux mais atteignables — la soif vit sur l'espoir crédible",
          "Le coach incarne l'énergie : une équipe ne dépasse jamais la soif de son staff",
        ],
        bulletsEn: [
          "Give MEANING: connect every scrim to a goal that matters to the player",
          "Make progress VISIBLE: show the curves, celebrate the milestones",
          "Build BELONGING: we win and lose together, never alone",
          "Set ambitious but reachable peaks — hunger lives on credible hope",
          "The coach embodies the energy: a team never exceeds its staff's hunger",
        ],
        tags: ["Identité", "Motivation"],
      },
    ],
  },
  {
    id: "player-modeling", label: "Modeling a Player", labelFr: "Modeler un Joueur", icon: UserCog, color: "#8b5cf6",
    entries: [
      {
        title: "Identifier l'archétype du joueur",
        body: ["Avant de modeler un joueur, il faut savoir qui il est. Chaque joueur a un profil : on ne façonne pas un carry égoïste comme un joueur d'équipe discret. Le diagnostic vient avant le traitement."],
        bodyEn: ["Before shaping a player, you need to know who they are. Every player has a profile: you don't sculpt a selfish carry like a quiet team player. Diagnosis comes before treatment."],
        bullets: [
          "Le carry égoïste : énorme potentiel à canaliser vers la win condition",
          "Le joueur d'équipe : fiable, à responsabiliser pour qu'il ose prendre l'espace",
          "Le talentueux inconstant : travailler la régularité et la routine, pas le skill",
          "Le bosseur plafonné : débloquer la lecture de jeu, pas la mécanique",
          "Le leader naturel : lui donner un vrai rôle de shotcall, le surcharger sinon",
        ],
        bulletsEn: [
          "The selfish carry: huge potential to channel toward the win condition",
          "The team player: reliable, empower them to dare to take space",
          "The inconsistent talent: work on consistency and routine, not skill",
          "The capped grinder: unlock game reading, not mechanics",
          "The natural leader: give them a real shotcall role, or they overload",
        ],
        tags: ["Modelage", "Archétype"],
      },
      {
        title: "Façonner sans casser l'identité",
        body: ["Modeler un joueur, ce n'est pas le transformer en quelqu'un d'autre. On amplifie ses forces, on cadre ses failles, mais on garde son style. Un joueur déraciné de son identité perd sa confiance et son flair."],
        bodyEn: ["Shaping a player isn't turning them into someone else. You amplify their strengths, frame their flaws, but keep their style. A player uprooted from their identity loses confidence and flair."],
        bullets: [
          "Amplifie les forces d'abord — c'est là que le retour est le plus rapide",
          "Donne-lui un rôle clair dans la compo qui colle à ses qualités",
          "Responsabilités progressives : on ajoute une couche quand la précédente tient",
          "Cadre les failles sans réécrire le joueur (corriger ≠ effacer le style)",
          "Mesure l'évolution : sans repère, le joueur ne voit pas qu'il grandit",
        ],
        bulletsEn: [
          "Amplify strengths first — that's where the return is fastest",
          "Give them a clear role in the comp that fits their qualities",
          "Progressive responsibility: add a layer once the previous one holds",
          "Frame flaws without rewriting the player (fix ≠ erase the style)",
          "Measure progress: without a marker, the player can't see they're growing",
        ],
        tags: ["Modelage", "Identité"],
      },
    ],
  },
  {
    id: "reach-player", label: "Reaching the Player", labelFr: "Atteindre le Joueur", icon: MessagesSquare, color: "#06b6d4",
    entries: [
      {
        title: "Créer le lien avant de corriger",
        body: ["Un joueur n'écoute vraiment qu'un coach en qui il a confiance. La relation se construit avant le feedback. Sans lien, la meilleure analyse du monde glisse sur le joueur."],
        bodyEn: ["A player only truly listens to a coach they trust. The relationship is built before the feedback. Without the bond, the best analysis in the world slides right off."],
        bullets: [
          "Connais le joueur hors-jeu : ce qui le motive, ce qui le bloque",
          "Écoute avant de corriger — pose des questions, ne déballe pas ta liste",
          "Cohérence parole/acte : un coach crédible fait ce qu'il dit",
          "Défends tes joueurs en public, corrige-les en privé",
          "1:1 réguliers, même courts : le lien se nourrit dans la constance",
        ],
        bulletsEn: [
          "Know the player off the game: what drives them, what blocks them",
          "Listen before correcting — ask questions, don't dump your list",
          "Word/action consistency: a credible coach does what they say",
          "Defend your players in public, correct them in private",
          "Regular 1:1s, even short: the bond feeds on consistency",
        ],
        tags: ["Lien", "Confiance"],
      },
      {
        title: "Faire passer le message sur le gameplay",
        body: ["Toucher un joueur sur le gameplay, c'est faire entrer une idée pour qu'elle change un réflexe. On ne décrit pas, on montre. On ne sermonne pas, on fait découvrir."],
        bodyEn: ["Reaching a player on gameplay means landing an idea so it changes a reflex. You don't describe, you show. You don't lecture, you let them discover."],
        bullets: [
          "Montre le clip plutôt que de décrire — l'image marque, les mots glissent",
          "Relie au vécu du joueur : « tu te souviens de la game vs X ? »",
          "Une analogie simple qui colle (vision = lumière, wave = monnaie)",
          "Fais trouver la réponse au joueur par des questions — il la retient",
          "Répète le même point jusqu'à l'automatisme, varie juste l'angle",
        ],
        bulletsEn: [
          "Show the clip rather than describe — the image sticks, words slide",
          "Tie it to the player's experience: \"remember the game vs X?\"",
          "A simple analogy that sticks (vision = light, wave = currency)",
          "Let the player find the answer through questions — they'll retain it",
          "Repeat the same point to automation, just vary the angle",
        ],
        tags: ["Lien", "Gameplay"],
      },
    ],
  ...
  {
    id: "good-habits", label: "Good Habits", labelFr: "Bonnes Habitudes", icon: Repeat, color: "#22c55e",
    entries: [
      {
        title: "Les routines du joueur pro",
        body: ["Le niveau ne vient pas des jours d'inspiration, il vient des routines. Ce que tu fais chaque jour sans y penser détermine ton plafond. Les bonnes habitudes remplacent la motivation."],
        bodyEn: ["Level doesn't come from inspired days, it comes from routines. What you do every day without thinking sets your ceiling. Good habits replace motivation."],
        bullets: [
          "Warmup structuré avant de jouer (last-hit, mécaniques, pas du ARAM)",
          "Review de ses propres games : 1 sur 5, pas zéro",
          "Sommeil et alimentation traités comme de la perf, pas comme du détail",
          "Soloq avec une intention (objectif PDI), pas du spam autopilote",
          "Journal de progression : noter 1 apprentissage par jour",
        ],
        bulletsEn: [
          "Structured warmup before playing (last-hit, mechanics, not ARAM)",
          "Review your own games: 1 in 5, not zero",
          "Sleep and nutrition treated as performance, not detail",
          "Soloq with an intent (IDP goal), not autopilot spam",
          "Progress journal: note 1 learning per day",
        ],
        tags: ["Habitudes", "Routine"],
      },
      {
        title: "Les habitudes qui font la différence",
        body: ["Entre deux joueurs de même skill, ce sont les habitudes invisibles qui décident. Elles ne se voient pas sur un highlight, mais elles se sentent sur une saison."],
        bodyEn: ["Between two players of equal skill, the invisible habits decide. They don't show on a highlight, but they're felt over a season."],
        bullets: [
          "Ponctualité systématique : présent et prêt avant l'heure",
          "Prep avant scrim : VOD regardés, plan en tête",
          "Attitude post-défaite : analyser, pas blâmer — le tilt se travaille",
          "Communication proactive : prévenir, pas subir",
          "Hygiène mentale : pauses réelles, jour off respecté, vie hors du jeu",
        ],
        bulletsEn: [
          "Systematic punctuality: present and ready before time",
          "Prep before scrim: VODs watched, plan in mind",
          "Post-loss attitude: analyze, don't blame — tilt is trainable",
          "Proactive communication: warn, don't endure",
          "Mental hygiene: real breaks, respected off day, life outside the game",
        ],
        tags: ["Habitudes", "Discipline"],
      },
    ],
  },
];

// ── Catégories de navigation du playbook ────────────────────────────────────────
const PB_CATEGORIES: { id: string; fr: string; en: string }[] = [
  { id: "jeu",     fr: "Sur la Faille",      en: "On the Rift"      },
  { id: "joueurs", fr: "Joueurs & Coaching", en: "Players & Coaching" },
  { id: "equipe",  fr: "Équipe & Org",       en: "Team & Org"       },
  { id: "dme",     fr: "Identité DME",       en: "DME Identity"     },
];

const SECTION_CAT: Record<string, string> = {
  early: "jeu", vision: "jeu", objectives: "jeu", draft: "jeu", macro: "jeu",
  teamfight: "jeu", teamplay: "jeu", mechanics: "jeu", meta: "jeu",
  "coaching-method": "joueurs", "player-dev": "joueurs", mental: "joueurs",
  "player-modeling": "joueurs", "reach-player": "joueurs", "good-habits": "joueurs",
  "team-mgmt": "equipe", "match-plans": "equipe", "org-build": "equipe",
  "dme-identity": "dme",
};
...
function tierColor(t: string) {
  return t === "S" ? "#fbbf24" : t === "A" ? "#22c55e" : t === "B" ? "#60a5fa" : "rgba(255,255,255,0.5)";
}
    ...
    >
      ...
      {open && (
        <div className="px-5 pb-5 border-t border-white/5 pt-4 space-y-3">
          ...
          {entry.champs && entry.champs.length > 0 && (
            <div className="mt-3 space-y-2.5">
              {entry.champs.map(t => (
                <div key={t.tier} className="flex items-start gap-3">
                  <span
                    className="mt-1.5 w-7 shrink-0 border text-center font-display text-sm leading-6"
...
export default function PlaybookPage() {
  ...
  const [openCats, setOpenCats] = useState<string[]>([SECTION_CAT[SECTIONS[0].id] ?? "jeu"]);
  const { lang } = useLang();
  const fr = lang === "fr";
      ...
      <div style={{ maxWidth: "1600px" }} className="mx-auto px-8 py-8">
        ...
        <motion.div variants={stagger()} initial="hidden" animate="visible" className="mb-7">
          ...
          <motion.h1 variants={fadeUp(0.1)} className="text-3xl font-display text-white mb-1">
            {fr ? "Le Playbook DME" : "The DME Playbook"}
          </motion.h1>
          <motion.p variants={fadeUp(0.2)} className="text-white/35 text-sm">
            {fr
              ? `La référence coaching DME · ${totalEntries} entrées · ${SECTIONS.length} sections · 4 univers`
              : `The DME coaching reference · ${totalEntries} entries · ${SECTIONS.length} sections · 4 worlds`}
          </motion.p>
        </motion.div>
